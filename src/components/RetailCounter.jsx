...
export default function RetailCounter() {
  return (
    <section id="retail-counter" className="relative bg-charcoal py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        >
          <img
            src={IMAGES.retailCounter.src}
            alt={IMAGES.retailCounter.alt}
        ...
        >
          ...
          <ul className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg">
            {FEATURES.map(({ icon: Icon, label }) => (
              <li key={label} className="flex items-center gap-3 font-body text-sm text-cream/75">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <a
              href={getWhatsAppLink("Hi, I'd like to enquire at the Ethnic Collections retail counter.")}
              target="_blank"
