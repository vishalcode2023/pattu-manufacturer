...
import { MessageCircle, Briefcase, ShoppingBag, ArrowRight } from "lucide-react";
  ...
  return (
    <section id="contact" className="relative bg-wine-dark py-24 sm:py-32 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-5 sm:px-8">
        ...
        >
          <Eyebrow tone="gold" className="justify-center">Get In Touch</Eyebrow>
          ...
          <p className="mt-8 mx-auto max-w-2xl font-body text-base sm:text-lg text-cream/80 leading-relaxed">
            Whether you're building a boutique collection, reselling online,
            or simply looking for a beautiful piece for your daughter — we have
        ...
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          >
            ...
            <h3 className="font-display text-3xl text-cream">Wholesale / B2B</h3>
          ...
          >
            ...
            <h3 className="font-display text-3xl text-cream">Shop Direct / B2C</h3>
            <p className="mt-3 font-body text-sm text-cream/70 leading-relaxed flex-1">
              Buying for your family? Order a single Pattu Pavada or Pattu
              Langa directly from us on WhatsApp.
            </p>
            <Link
              to="/b2c"
