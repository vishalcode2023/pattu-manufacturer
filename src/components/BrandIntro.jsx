      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        >
          <div className="relative overflow-hidden rounded-sm">
            ...
            >
              <source src="/EC_Reel_5.mp4" type="video/mp4" />
        ...
        >
          ...
          <div className="mt-8 space-y-5 max-w-xl text-brown font-body text-base sm:text-lg leading-relaxed">
            <p>
              We specialise in manufacturing traditional South Indian
              girls&rsquo; ethnic wear — Pattu Pavada, Pattu Langa, Langa Blouse
              and Uddalanga — built on manufacturing expertise passed down
              through generations of South Indian textile craft.
            </p>

            <p>
              Every collection reflects consistent quality, traditional
              craftsmanship and contemporary design, produced at a scale that
              supports bulk supply and worldwide shipping for boutiques,
              resellers and families alike.
            </p>
          </div>
