  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-wine-dark/50 via-transparent to-transparent" />
      </motion.div>
      ...
      <div className="relative z-10 w-full mx-auto max-w-7xl px-5 sm:px-8 pb-16 sm:pb-20 pt-40">
        <div className="max-w-3xl">
          ...
          <motion.h1
            ...
            className="mt-6 font-display font-medium text-cream leading-[1.02] text-balance text-5xl sm:text-6xl lg:text-7xl xl:text-[5.25rem]"
          >
          ...
          >
            Premium Pattu Pavada, Pattu Langa and Langa Blouse manufacturing
            from Mysuru, supplying boutiques, resellers and customers across
            India and the global South Indian community.
          </motion.p>
